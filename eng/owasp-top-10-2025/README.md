...
| [A05: Injection](a05-injection/01-overview.md) | Completed after SQLi and NoSQL labs | Includes SQL Injection and NoSQL Injection notes, UNION-based SQLi, blind SQLi, NoSQL detection and extraction labs, checklist, learning notes, four findings and regression tests. |
