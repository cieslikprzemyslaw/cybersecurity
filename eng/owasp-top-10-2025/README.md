...
| [A08: Software or Data Integrity Failures](a08-software-or-data-integrity-failures/01-overview.md) | Completed | Includes integrity and authenticity notes, checklist, example finding and regression tests. |
