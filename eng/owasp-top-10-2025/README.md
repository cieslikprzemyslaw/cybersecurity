...
| [A02 Security Misconfiguration](a02-security-misconfiguration/01-overview.md) | Completed after practice review | Includes a TryHackMe verbose API error disclosure task, checklist, example finding and regression tests. |
