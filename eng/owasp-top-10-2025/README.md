...
| [A05: Injection](a05-injection/01-overview.md) | Completed after SQLi, NoSQL, and OS Command Injection labs | Includes SQL Injection, NoSQL Injection, and OS Command Injection notes, UNION-based SQLi, blind SQLi, NoSQL detection/extraction, direct and blind command-injection labs, checklist, learning notes, five findings, and regression tests. |
